...
* **Scenario 2: You use AWS security services but not Sumo Logic.** You use the AWS security services listed under link:#_specialized_knowledge[Specialized knowledge] but have not configured Sumo 
