...
//TODO Shivansh, Do we need to customize the answer above?

IMPORTANT: When you set *Rollback on failure* to *Disabled*, you continue to incur AWS charges for this stack. Delete the stack when you finish troubleshooting.
