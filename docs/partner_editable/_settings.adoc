...
:partner-contributors: Timothy MacDonald, Director-Partner Architect, Sumo Logic
:aws-contributors: Dilip Rajan and Vinay Maddi, Sr Partner Solutions Architects 
:quickstart-contributors: Shivansh Singh and Suresh Veeragoni, AWS Integration & Automation team
