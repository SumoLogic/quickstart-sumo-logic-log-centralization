...
# App to test
export AppTemplateName="CIS-Foundations"
export AppName="cisfoundations"
...
do
    ...
    aws cloudformation deploy --profile ${AWS_PROFILE} --region ${AWS_REGION} --template-file ./CIS-Foundations.template.yaml \
